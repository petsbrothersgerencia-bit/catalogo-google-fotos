...
APP_VERSION = "FINAL_3_CATALOGOS_SP_FIX_CODIGOS_GUION_FOTOS_MANUALES_FECHA_Y_SP_DESDE_OTRO_PDF_2026_07_07"
...
def app():
    ...
    st.title("FINAL: 3 CATÁLOGOS + SP + FIX CÓDIGOS + FOTOS MANUALES + FECHA + SP DESDE PDF")
    ...
    with tab_update:
        ...
        if catalog_key in {"4PETS", "P3TS"}:
            ...
            if sp_analysis:
                ...
                with st.expander("Ver códigos posibles agotados para SP"):
                    st.write(codes_preview(sp_exhausted_codes) or "No hay posibles agotados.")
