...
APP_VERSION = "FINAL_2_CATALOGOS_CODIGO_RECONSTRUIR_UPLOAD_FIX_SOLO_RECONSTRUCCION_2026_06_22"
...
def upload_pdf_widget(label: str, key: str) -> Optional[Tuple[bytes, str]]:
    ...
    - incluye un cargador alternativo sin filtro cuando el botón Browse files se pone rojo y vuelve a gris.
    """
    ...
    uploaded = st.file_uploader(
        ...
        help="Selecciona un PDF desde Archivos/Mis archivos/Descargas.",
    )
    ...
    if stored_data:
        ...
        st.caption("PDF listo para procesar. Si no es el archivo correcto, limpia y vuelve a cargarlo.")
