...
def google_photos_tab(settings: Dict) -> None:
    ...
    st.caption("Paso 1: selecciona el PDF. Paso 2: confirma que aparece como 'PDF listo para procesar'. Paso 3: toca el botón de subida.")
    initial_pdf = persistent_pdf_uploader("Sube el primer PDF para llenar el álbum maestro", key="initial_pdf")
    ...
    update_pdf = persistent_pdf_uploader("Sube el nuevo PDF del catálogo", key="update_pdf")
