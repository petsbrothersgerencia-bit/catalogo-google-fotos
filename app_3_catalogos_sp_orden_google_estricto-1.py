...
APP_VERSION = "FINAL_3_CATALOGOS_SP_SIN_PRECIO_ORDEN_GOOGLE_ESTRICTO_2026_06_26"
...
def upload_products_to_album(album_id: str, products: List[ProductCrop], catalog_key: str, catalog_title: str, token: str, label: str = "Subiendo imágenes") -> int:
    ...
    Antes se subían todos los bytes y luego se creaban elementos en lotes. En algunos álbumes,
    Google Fotos podía mostrar esos lotes mezclados. Ahora se hace así:
    1. subir bytes del producto 0001
    2. crear elemento 0001 al final del álbum
    3. subir bytes del producto 0002
    4. crear elemento 0002 al final del álbum
    """
    if not products:
        return 0
...
def app():
    ...
    st.title("FINAL: 3 CATÁLOGOS + SP SIN PRECIO")
