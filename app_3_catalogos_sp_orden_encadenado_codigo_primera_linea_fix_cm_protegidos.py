...
APP_VERSION = "FINAL_3_CATALOGOS_SP_ORDEN_ENCADENADO_CODIGO_PRIMERA_LINEA_FIX_CM_PROTEGIDOS_2026_07_10"
...
def app():
    ...
    st.title("FINAL: 3 CATÁLOGOS + SP + CÓDIGO PRIMERA LÍNEA + CM PROTEGIDOS")
